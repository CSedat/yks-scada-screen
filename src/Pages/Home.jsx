        ...
        <div className='text-white text-center gap-4 place-items-stretch ' >
                ...
                <div className='grid gap-4'>
                    ...
                    <div className=' border border-1 rounded '>
                        ...
                        <div className='rounded grid grid-cols-4 items-center text-xs'    >
                            ...
                            <div style={{backgroundColor: bk1ropestatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            <div style={{backgroundColor: bk2ropestatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            <div style={{backgroundColor: bk3ropestatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            <div style={{backgroundColor: bk4ropestatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            ...
                            <div style={{backgroundColor: bk1speedswstatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            <div style={{backgroundColor: bk2speedswstatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            <div style={{backgroundColor: bk3speedswstatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                            <div style={{backgroundColor: bk4speedswstatus ? 'green' : 'red'}} className=' h-8 border border-1 rounded-full w-8 mx-auto'></div>
                        </div>
                    </div>
                </div>
            </div>
            <Stack className='absolute top-0 left-0 w-1/4 h-96  m-2'>
                <div className='bg-gray-300 rounded max-h-16 text-black justify-center items-center text-center'>
                    ...
                    {
                        bk1 ? 
                        <Manual id='1' status={status1} setmanbantstrt={Bk1manbantstrt} setmanbantstp={Bk1manbantstp} setmanklpopen={Bk1manklpopen} setmanklpclose={Bk1manklpclose} sethertz={updateBk1hertz} hertz={bk1hertz} referans={bk1referans}/> 
                        : 
            ...
            <Stack className='absolute top-0 right-0 w-1/4 h-96  m-2'>
                <div className='bg-gray-300 rounded max-h-16 text-black justify-center items-center text-center'>
                    ...
                    {
                        bk2 ? 
                        <Manual id='2' status={status2} setmanbantstrt={Bk2manbantstrt} setmanbantstp={Bk2manbantstp} setmanklpopen={Bk2manklpopen} setmanklpclose={Bk2manklpclose} sethertz={updateBk2hertz} hertz={bk2hertz} referans={bk2referans}/> 
                        : 
            ...
            <Stack className='absolute bottom-0 left-0 w-1/4 h-[28rem]  m-2'>
                <div className='bg-gray-300 rounded max-h-16 text-black justify-center items-center text-center'>
                    ...
                    {
                        bk3 ? 
                        <Manual id='3' status={status3} setmanbantstrt={Bk3manbantstrt} setmanbantstp={Bk3manbantstp} setmanklpopen={Bk3manklpopen} setmanklpclose={Bk3manklpclose} sethertz={updateBk3hertz} hertz={bk3hertz} referans={bk3referans}/> 
                        : 
            ...
            <Stack className='absolute bottom-0 right-0 w-1/4 h-[28rem] m-2'>
                <div className='bg-gray-300 rounded max-h-16 text-black justify-center items-center text-center'>
                    ...
                    {
                        bk4 ? 
                        <Manual id='4' status={status4} setmanbantstrt={Bk4manbantstrt} setmanbantstp={Bk4manbantstp} setmanklpopen={Bk4manklpopen} setmanklpclose={Bk4manklpclose} sethertz={updateBk4hertz} hertz={bk4hertz} referans={bk4referans}/> 
                        : 
            ...
            <div className='bg-gray-700 text-white h-auto p-2 rounded '>
                <div className=' p-1 m-1 bg-gray-300 rounded text-black'>
                    ...
                    <div className='bg-gray-500 rounded-b p-2 grid grid-cols-2'>
                        ...
                        <p className=' col-span-2 m-1 text-white '>Anlık Hız: {props.referans}%</p>
                    </div>
                    <h1 className=' rounded gap-2 p-1 m-2 text-white uppercase '>
                        {(() => {
                        switch (props.status) {
